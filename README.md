...
- **뉴스 기사 인기도 예측 AI 모델 개발 (2025)**
  - 데이터 전처리 및 머신러닝 모델 설계 / 성능 개선 및 검증

- **Vuforia 및 Unity 기반 교내 지름길 안내 모바일 앱 개발 (2025)**
  - UI 구현 및 AR 이미지 타겟팅 담당 / 최종 빌드 수행

- **학생 마켓 웹사이트 개발 (2024)**
  - 프론트엔드 팀 리더 / UI 설계·구현 및 API 연동 검토

- **학생 식당 주문 관리 시스템 DB 설계 (2024)**
  - ERD 기반 데이터베이스 설계 및 구축 / 쿼리 오류 분석·개선
  <br>
...
![GitHub Stats](https://github-readme-stats-fast.vercel.app/api/streak?username=minha222)
...
- **Huawei Seeds for the Future (China, 2025)**
  ...
  - **한국 대표단**의 일원으로 **중국 동관·심천 현지 연수**
  - 5G, AI, Cloud Computing 등 **최신 ICT 기술 학습**
  - **Huawei 본사 및 스마트 시티 견학**
  - **9개국 참가자들**과의 팀 프로젝트 및 **글로벌 협업** 경험
  <br>
